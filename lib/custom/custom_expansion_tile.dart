...
/// [CustomExpansionPile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [CustomExpansionPile].
///
/// {@tool dartpad}
/// This example demonstrates different configurations of CustomExpansionPile.
///
...
class CustomExpansionPile extends StatefulWidget {
  ...
  @override
  State<CustomExpansionPile> createState() => _ExpansionTileState();
}

class _ExpansionTileState extends State<CustomExpansionPile>
